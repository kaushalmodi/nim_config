...
That will print:
#+begin_example
installPcre          Installs PCRE using musl-gcc
installLibreSsl      Installs LIBRESSL using musl-gcc
installOpenSsl       Installs OPENSSL using musl-gcc
musl                 Builds an optimized static binary using musl
test                 Run tests via 'nim doc' and runnableExamples and tests in tests dir
